/**
 * This GUI program calculates the cost of purchasing several items.
 * 
 * date due     20210218
 * @filename    MakingPurchasesAgain.java
	...
	public MakingPurchasesAgain() {
		...
		btnCalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				final double BOUNCYBALLPRICE = 1.99;
				final double NOBOUNCEPRICE = 1.50;
				final double BUBBLEGUMPRICE = 1.99;
				final double RUBBERDUCKPRICE = 2.50;
				final double HIGHFIVEPRICE = 7.99;
				
				subtotal = (totalBouncyBall*BOUNCYBALLPRICE) + (totalNoBounce*NOBOUNCEPRICE) + (totalNoBalls*0) + (totalBubbleGum*BUBBLEGUMPRICE) + (totalRubberDuck*RUBBERDUCKPRICE) + (totalHighFive*HIGHFIVEPRICE);
				tax = subtotal * 0.13;
